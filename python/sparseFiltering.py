...
# my addition to play nicely with sklearn--not in original
class SparseClusterer(object):

	def __init__(self, nFeatures=-1): # TODO allow multiple layers?
	...
	def fit(self, X):
		...
		self.cluster_centers_ = sparseFiltering(self.nFeatures, X.T)
